...
public class AudioStreamRecorder extends FrameRecorder {
    ...
    public static AudioStreamRecorder createDefault(File f, int w, int h) throws Exception {
        return new AudioStreamRecorder(f, w, h);
    }

    public static AudioStreamRecorder createDefault(String f, int w, int h) throws Exception {
        return new AudioStreamRecorder(f, w, h);
    }
    ...
    public AudioStreamRecorder(File file, int audioChannels) {
        this(file, 0, 0, audioChannels);
    }

    public AudioStreamRecorder(String filename, int audioChannels) {
        this(filename, 0, 0, audioChannels);
    }

    public AudioStreamRecorder(File file, int imageWidth, int imageHeight) {
        this(file, imageWidth, imageHeight, 0);
    }

    public AudioStreamRecorder(String filename, int imageWidth, int imageHeight) {
        this(filename, imageWidth, imageHeight, 0);
    }

    public AudioStreamRecorder(File file, int imageWidth, int imageHeight, int audioChannels) {
        this(file.getAbsolutePath(), imageWidth, imageHeight, audioChannels);
    }

    public AudioStreamRecorder(String filename, int imageWidth, int imageHeight, int audioChannels) {
    ...
    public AudioStreamRecorder(OutputStream outputStream, int audioChannels) {
        this(outputStream.toString(), audioChannels);
        this.outputStream = outputStream;
        this.closeOutputStream = true;
    }

    public AudioStreamRecorder(OutputStream outputStream, int imageWidth, int imageHeight) {
        this(outputStream.toString(), imageWidth, imageHeight);
        this.outputStream = outputStream;
        this.closeOutputStream = true;
    }

    public AudioStreamRecorder(OutputStream outputStream, int imageWidth, int imageHeight, int audioChannels) {
