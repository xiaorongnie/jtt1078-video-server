 ...
 * <p>
 * These routines comprise an implementation of the CCITT G.726 16kbps ADPCM coding algorithm. Essentially, this
...
public class G726_16 extends G726 {
    ...
    /**
     * Encodes a 16-bit linear PCM, A-law or u-law input sample and retuens the resulting 5-bit CCITT G726 16kbps code.
    ...
    /**
     * Encodes the input chunk in_buff of linear PCM, A-law or u-law data and returns the G726_16 encoded chuck into
     * out_buff. <br>
    ...
    /**
     * Decodes the input chunk in_buff of G726_16 encoded data and returns the linear PCM, A-law or u-law chunk into
     * out_buff. <br>
