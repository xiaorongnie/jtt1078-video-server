package com.transcodegroup.jtt1078.core.codec.g726;

import com.transcodegroup.jtt1078.core.codec.G711Codec;
import com.transcodegroup.jtt1078.core.codec.G711UCodec;

/**
 * G726_40 encoder and decoder.
 * <p>
 * These routines comprise an implementation of the CCITT G.726 40kbps ADPCM coding algorithm. Essentially, this
 * implementation is identical to the bit level description except for a few deviations which take advantage of
 * workstation attributes, such as hardware 2's complement arithmetic.
 * <p>
 * The deviation from the bit level specification (lookup tables), preserves the bit level performance specifications.
 * <p>
 * As outlined in the G.723 Recommendation, the algorithm is broken down into modules. Each section of code below is
 * preceded by the name of the module which it is implementing.
 * <p>
 * This implementation is based on the ANSI-C language reference implementations of the CCITT (International Telegraph
 * and Telephone Consultative Committee) G.711, G.721 and G.723 voice compressions, provided by Sun Microsystems, Inc.
 * <p>
...
public class G726_40 extends G726 {
     ...
     * magnitude values.
     */
    static /*short*/int[] _dqlntab = {-2048, -66, 28, 104, 169, 224, 274, 318, 358, 395, 429, 459, 488, 514, 539, 566,
        566, 539, 514, 488, 459, 429, 395, 358, 318, 274, 224, 169, 104, 28, -66, -2048};

    /* Maps G723_40 code word to log of scale factor multiplier. */
    static /*short*/int[] _witab = {448, 448, 768, 1248, 1280, 1312, 1856, 3200, 4512, 5728, 7008, 8960, 11456, 14080,
        16928, 22272, 22272, 16928, 14080, 11456, 8960, 7008, 5728, 4512, 3200, 1856, 1312, 1280, 1248, 768, 448, 448};
     ...
     */
    static /*short*/int[] _fitab = {0, 0, 0, 0, 0, 0x200, 0x200, 0x200, 0x200, 0x200, 0x400, 0x600, 0x800, 0xA00, 0xC00,
        0xC00, 0xC00, 0xC00, 0xA00, 0x800, 0x600, 0x400, 0x200, 0x200, 0x200, 0x200, 0x200, 0, 0, 0, 0, 0};

    static /*short*/int[] qtab_723_40 = {-122, -16, 68, 139, 198, 250, 298, 339, 378, 413, 445, 475, 502, 528, 553};

    /**
     * Encodes a 16-bit linear PCM, A-law or u-law input sample and retuens the resulting 5-bit CCITT G726 40kbps code.
     * Returns -1 if the input coding value is invalid.
     */
    public static int encode(int sl, int in_coding, G726State state) {

        /*short*/int sei, sezi, se, sez;
        /* ACCUM */
        /*short*/int d;
        /* SUBTA */
        /*short*/int y;
    ...
    /**
     * Decodes a 5-bit CCITT G.726 40kbps code and returns the resulting 16-bit linear PCM, A-law or u-law sample value.
     * -1 is returned if the output coding is unknown.
     */
    public static int decode(int i, int out_coding, G726State state) {

        /*short*/int sezi, sei, sez, se;
        /* ACCUM */
        /*short*/int y;
        /* MIX */
        /*short*/int sr;
    ...
    /**
     * Encodes the input chunk in_buff of linear PCM, A-law or u-law data and returns the G726_40 encoded chuck into
     * out_buff. <br>
     * It returns the actual size of the output data, or -1 in case of unknown in_coding value.
     */
    public static int encode(byte[] in_buff, int in_offset, int in_len, int in_coding, byte[] out_buff, int out_offset,
        G726State state) {
    ...
    /**
     * Decodes the input chunk in_buff of G726_40 encoded data and returns the linear PCM, A-law or u-law chunk into
     * out_buff. <br>
     * It returns the actual size of the output data, or -1 in case of unknown out_coding value.
     */
    public static int decode(byte[] in_buff, int in_offset, int in_len, int out_coding, byte[] out_buff, int out_offset,
        G726State state) {
    ...
    /**
     * Encodes a 16-bit linear PCM, A-law or u-law input sample and retuens the resulting 5-bit CCITT G.726 40kbps code.
     * Returns -1 if the input coding value is invalid.
     */
