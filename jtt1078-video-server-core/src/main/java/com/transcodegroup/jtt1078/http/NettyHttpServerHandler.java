package com.transcodegroup.jtt1078.http;
...
public class NettyHttpServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(final ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (uri.startsWith("/video/")) {
            ...
            FullHttpResponse response =
                new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.valueOf(403), body);
    ...
    private void responseHTMLFile(String htmlFilePath, ChannelHandlerContext ctx) {
        ...
        FullHttpResponse response =
            new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.valueOf(200), body);
